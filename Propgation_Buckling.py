...
ppr = (Maximum_External_Pressure - Min_Internal_Pressure) * Material_Factor * Safety_Class_Resistance_Factor_Others

Min_WT_Propgation_Buckling_WO_Cor = (ppr/(35*Char_Yield_Stress*Fabrication_Factor))**(1/2.5)*Steel_Pipe_Diameter
